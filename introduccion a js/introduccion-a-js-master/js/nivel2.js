...
//const comidasFavoritas = ["milanesas", "asado", "empanadas", "pizza"]
...
// TAREA: Obtené el tercer elemento de tu array comidasFavoritas e 
//imprimilo utilizando console.log.
/*let primerEspacio = comidasFavoritas[0]
console.log(primerEspacio)
let segundoEspacio = comidasFavoritas[1]
console.log(segundoEspacio)
*/
/*
...
    array todavía se pueden cambiar; el array en sí no se puede sobrescribir.
    ...
    // Esto es legal y funciona de la misma manera 
    que cuando los animales son una variable:
    animales[1] = 'pez';
    animales.push('conejo');
